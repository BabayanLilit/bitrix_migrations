<?php
//добавление свойства типа дата время
...
$propertCode = "DATE_TIME_CODE";
$iblId = $getIblIdByCode($iblockCode);
//отличие от строки только в этом
//"PROPERTY_TYPE" => "S" и "USER_TYPE" => "DateTime" ,
$iblPropertyFields = array(
    "NAME" => "cвойство типа дата/время ",
    "SORT" => "500",
    "CODE" => $propertCode,
    "MULTIPLE" => "N",
    "IS_REQUIRED" => "Y",
    ...
    "USER_TYPE" => "DateTime",
    "LINK_IBLOCK_ID" => "",
    "DEFAULT_VALUE" => "12.07.2016 18:00:00",
    "USER_TYPE_SETTINGS" => "",
    "WITH_DESCRIPTION" => "N",
    "SEARCHABLE" => "N",
    "FILTRABLE" => "N",
